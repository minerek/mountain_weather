...
TRASY: dict[str, list[dict]] = {
    ...
    "Zadni Granat": [
        {"start": "Kuźnice",
         "przez": ["Murowaniec", "Czarny Staw Gąsienicowy", "Kozia Dolinka"],
         "czas": "6:30–7:30 h (tam i z powrotem)",
         "znaki": "niebieski → zielony → żółty",
         "trudnosc": "0 — szlak turystyczny, chodzenie po dużych głazach",
         "uwagi": None},
    ],
    "Sarnia Skała": [
    ...
    "Wielki Kopieniec": [
        {"start": "Toporowa Cyrhla",
         "przez": ["Polana Kopieniec"],
         "czas": "2:00–2:30 h (tam i z powrotem)",
         "znaki": "zielony",
         "trudnosc": "0 — bardzo łatwa krótka ścieżka spacerowa",
         "uwagi": None},
    ],
