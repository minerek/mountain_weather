...
SZCZYTY = {
    ...
    "Jagnięcy Szczyt (Jahňací štít)":                (49.2198, 20.2136, 2230, "Tatry Słowackie"),
    ...
    "Kieżmarski Szczyt (Kežmarský štít) ⭐WKT":   (49.1905, 20.2212, 2558, "Tatry Słowackie"),
...
TRASY: dict[str, list[dict]] = {
    ...
    "Kieżmarski Szczyt (Kežmarský štít) ⭐WKT": [
        {"start": "Tatranská Lomnica",
         "przez": ["Hrebienok", "Studená dolina", "Téryho chata", "Kežmarské sedlo"],
         "km": 11.0, "czas": "6–8 h",
         "znaki": "zielony → żółty", "uwagi": "⚠️ Wymagany przewodnik tatrzański UIMLA"},
    ],
    "Kończysta (Končistá) ⭐WKT": [
    ...
    "Baranie Rogi (Baranie rohy) ⭐WKT": [
        {"start": "Tatranská Lomnica",
         "przez": ["Hrebienok", "Malá Studená dolina", "Téryho chata", "Baranie sedlo"],
         "km": 11.5, "czas": "6–8 h",
         "znaki": "zielony → żółty", "uwagi": "⚠️ Wymagany przewodnik tatrzański UIMLA"},
    ],
    "Krywań (Kriváň) ⭐WKT": [
    ...
    "Pośrednia Grań (Prostredný hrot) ⭐WKT": [
        {"start": "Tatranská Lomnica",
         "przez": ["Hrebienok", "Veľká Studená dolina", "Zbojnícka chata", "Veľká Zmrzlá dolina"],
         "km": 12.0, "czas": "6–8 h",
         "znaki": "zielony → żółty", "uwagi": "⚠️ Wymagany przewodnik tatrzański UIMLA"},
    ],
