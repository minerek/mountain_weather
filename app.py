...
SZCZYTY = {
    ...
    "Rysy ⭐WKT":                                    (49.1794, 20.0883, 2501, "Tatry Polskie"),
    "Turnia nad Grzędą (Hrubý štít)":               (49.2014, 20.0461, 2472, "Tatry Polskie"),
    "Kozi Wierch":                                   (49.2183, 20.0172, 2291, "Tatry Polskie"),
    "Kozie Czuby — wierz. E":                        (49.2161, 20.0128, 2263, "Tatry Polskie"),
    "Kozie Czuby — wierz. W":                        (49.2156, 20.0094, 2239, "Tatry Polskie"),
    "Mały Kozi Wierch":                              (49.2197, 20.0072, 2228, "Tatry Polskie"),
    "Zadni Granat":                                  (49.2247, 20.0294, 2240, "Tatry Polskie"),
    "Pośredni Granat":                               (49.2261, 20.0331, 2234, "Tatry Polskie"),
    "Skrajny Granat":                                (49.2278, 20.0367, 2225, "Tatry Polskie"),
    "Żabi Koń":                                      (49.2108, 20.0597, 2291, "Tatry Polskie"),
    "Jagnięcy Szczyt (Jahňací štít)":                (49.2153, 20.0733, 2229, "Tatry Polskie"),
    "Żabi Szczyt Polski":                            (49.2069, 20.0647, 2259, "Tatry Polskie"),
    "Mięguszowiecki Szczyt Wielki":                  (49.1972, 20.0669, 2438, "Tatry Polskie"),
    "Mięguszowiecki Szczyt Czarny":                  (49.1953, 20.0644, 2410, "Tatry Polskie"),
    "Mięguszowiecki Szczyt Pośredni":                (49.1961, 20.0658, 2393, "Tatry Polskie"),
    "Cubryna":                                       (49.2025, 20.0561, 2376, "Tatry Polskie"),
    "Szpiglasowy Wierch (Hrubý štít) — gł.":        (49.2047, 20.0347, 2172, "Tatry Polskie"),
    "Szpiglasowy Wierch — wierz. środk.":            (49.2039, 20.0358, 2171, "Tatry Polskie"),
    "Raczkowa Czuba (Jakubina)":                     (49.2164, 19.9644, 2194, "Tatry Polskie"),
    "Kazalnica":                                     (49.2200, 20.0025, 2159, "Tatry Polskie"),
    "Kościelec":                                     (49.2297, 20.0272, 2155, "Tatry Polskie"),
    "Zawrat":                                        (49.2233, 20.0100, 2159, "Tatry Polskie"),
    "Świnica (Svinica)":                             (49.2175, 19.9708, 2301, "Tatry Polskie"),
    "Morskie Oko":                                   (49.2017, 20.0717, 1395, "Tatry Polskie"),
    "Czarny Staw pod Rysami":                        (49.1950, 20.0783, 1580, "Tatry Polskie"),
    "Mały Kościelec":                                (49.2278, 20.0183, 1866, "Tatry Polskie"),
    "Nosal":                                         (49.2658, 19.9678, 1206, "Tatry Polskie"),
    "Gęsia Szyja":                                   (49.2769, 20.0272, 1490, "Tatry Polskie"),
    "Sarnia Skała":                                  (49.2858, 20.0044, 1377, "Tatry Polskie"),
    "Wielki Kopieniec":                              (49.2772, 19.9914, 1328, "Tatry Polskie"),

    # ---------- TATRY ZACHODNIE (polskie i słowackie) ----------
    "Bystra (Bystrá)":                               (49.2436, 19.8956, 2248, "Tatry Zachodnie"),
    "Starorobociański Wierch (Klin)":                (49.2422, 19.8631, 2176, "Tatry Zachodnie"),
    "Wołowiec (Volovec)":                            (49.2592, 19.8481, 2064, "Tatry Zachodnie"),
    "Baraniec (Baranec)":                            (49.1844, 19.7372, 2185, "Tatry Zachodnie"),
    "Banówka (Baníkov)":                             (49.1969, 19.8183, 2178, "Tatry Zachodnie"),
    "Hruba Kopa (Hrubá kopa)":                       (49.1994, 19.8267, 2166, "Tatry Zachodnie"),
    "Rohacz Ostry (Ostrý Roháč)":                    (49.1911, 19.7711, 2088, "Tatry Zachodnie"),
    "Spalona Kopa — wierz. N (Spálená)":             (49.2089, 19.8481, 2083, "Tatry Zachodnie"),
    "Spalona Kopa — wierz. S (Spálená)":             (49.2078, 19.8469, 2080, "Tatry Zachodnie"),
    "Smrek":                                         (49.2156, 19.8639, 2072, "Tatry Zachodnie"),
    "Kopa Kondracka (Kondratova kopa)":              (49.2461, 19.9344, 2005, "Tatry Zachodnie"),
    "Rohacz Płaski (Plochý Roháč)":                  (49.1947, 19.7606, 2001, "Tatry Zachodnie"),
    "Kończysty Wierch (Končistá)":                   (49.2344, 19.8544, 2002, "Tatry Zachodnie"),
    "Kasprowy Wierch (Kasprový vrch)":               (49.2317, 19.9817, 1987, "Tatry Zachodnie"),
    "Krzesanica (Kresanica)":                        (49.2469, 19.9142, 2122, "Tatry Zachodnie"),
    "Małołączniak (Malolúčniak)":                    (49.2469, 19.9228, 2096, "Tatry Zachodnie"),
    "Ciemniak (Temniak)":                            (49.2522, 19.9083, 2096, "Tatry Zachodnie"),
    "Tomanowy Wierch":                               (49.2278, 19.9028, 2103, "Tatry Zachodnie"),
    "Skrajne Solisko (Predné Solisko)":              (49.2156, 19.9697, 2117, "Tatry Zachodnie"),
    ...
    "Giewont":                                       (49.2508, 19.9347, 1894, "Tatry Zachodnie"),
    "Rakoń (Rákoň)":                                 (49.2644, 19.7628, 1879, "Tatry Zachodnie"),
    "Świstowa Kopa":                                 (49.2489, 19.8811, 1875, "Tatry Zachodnie"),
    "Ornak":                                         (49.2575, 19.8247, 1854, "Tatry Zachodnie"),
    "Siwy Wierch (Sivý vrch)":                       (49.2356, 19.8014, 1805, "Tatry Zachodnie"),
    "Trzydniowiański Wierch":                        (49.2542, 19.8061, 1765, "Tatry Zachodnie"),
    "Grześ (Lúčna)":                                 (49.2842, 19.8197, 1653, "Tatry Zachodnie"),
    "Salatín (Salatyński Wierch)":                   (49.1797, 19.7253, 2048, "Tatry Zachodnie"),
    ...
    "Jarząbczy Wierch (Hrubý vrch)":                 (49.2358, 19.8689, 2137, "Tatry Zachodnie"),
    ...
    "Rohacz Płaczliwy (Plačlivý Roháč)":             (49.1958, 19.7578, 2126, "Tatry Zachodnie"),
    ...
    "Mała Wysoka (Východná Vysoká)":              (49.1833, 20.1053, 2429, "Tatry Słowackie"),
    "Koprowy Wierch (Kôprovský štít)":            (49.1908, 20.0181, 2363, "Tatry Słowackie"),
